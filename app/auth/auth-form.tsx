...
export default function AuthForm() {
  ...
  return (
    <section className="card flex flex-1 flex-col justify-center bg-white p-8 lg:p-10">
      {/* Login/Signup Toggle */}
      <div className="flex gap-2 rounded-xl border-2 border-black bg-white p-1 text-xs font-bold uppercase tracking-wider shadow-[3px_3px_0_#000]">
        <button
          type="button"
          onClick={() => setMode("login")}
          className={`flex-1 rounded-lg px-4 py-2 transition-all duration-200 ${
            mode === "login" 
              ? "bg-blue-300 text-black shadow-[2px_2px_0_#000]" 
        ...
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-2 transition-all duration-200 ${
            mode === "signup" 
              ? "bg-purple-400 text-white shadow-[2px_2px_0_#000]" 
              : "text-black hover:scale-105"
          }`}
        >
          Signup
